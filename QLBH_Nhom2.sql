...
insert into khachhang
	values 
		('KH001', N'Công Ty A', N'Nguyễn Văn A', N'123 Đường A, Quận 1', 'a@gmail.com', '0123456789', '0212345678'),
		...
		('KH004', N'Công Ty D', N'Phạm Thị D', N'321 Đường D, Quận 4', 'd@gmail.com', '0987654320', '0298765430'),
...
insert into nhanvien
	values
		('NV001', N'Nguyễn', N'An', '1960-01-15', '1980-05-01', N'123 Đường A, Quận 1', '0123486789', 6000000, 1000000),
		...
		('NV004', N'Phạm', N'Duy', '1990-04-10', '2022-08-20', N'321 Đường D, Quận 4', '0987654312', 5800000, 1150000),
		('NV005', N'Nguyễn', N'Em', '1991-05-25', '2020-09-01', N'654 Đường E, Quận 5', '0123456781', 5200000, 1050000),
		('NV006', N'Trần', N'Phú', '1989-06-30', '2023-01-15', N'987 Đường F, Quận 6', '0987654323', 6000000, 1250000),
		...
		('NV009', N'Nguyễn', N'Thảo', '1990-04-10', '2018-03-15', N'357 Đường I, Quận 9', '0123456783', 5700000, 1150000),
...
select distinct m.macongty, n.tencongty,n.diachi, l.tenloaihang
...
select distinct  k.tengiaodich, m.tenhang
...
select makhachhang, tengiaodich as doitac
from KHACHHANG
...
/*select manhanvien, max(luongcoban)
from NHANVIEN
group by (manhanvien)
having max(luongcoban) >= all (select top 1 luongcoban from NHANVIEN)*/